...
- The `Proposal.versions` attribute is no longer nullable.
- The `ProposalVersion.fieldValues` attribute is no longer nullable.
- The `ApplicationForm.fields` attribute is no longer nullable.

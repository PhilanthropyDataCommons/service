...
- Added `has_application_form_permission`, `has_application_form_field_permission`, `has_bulk_upload_permission`, `has_proposal_version_permission`, and `has_source_permission` authorization functions so every `permission_grant_entity_type_t` has a direct permission check.

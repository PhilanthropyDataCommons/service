...
# Auto-publishing to the PhilanthropyDataCommons.org web site
...
- [Action](https://github.com/OpenTechStrategies/wp-post-gfm)
...
To a limited extent, files can contain [frontmatter](https://github.com/jonschlinkert/gray-matter#what-does-this-do) that affects publishing behavior:
...
Not related to WordPress metadata. When set to true, it prevents a file from
being sent to WordPress at all. See the top of this document for example.

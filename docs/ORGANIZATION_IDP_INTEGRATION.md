...
8. Click "Next."
9. Paste the Single sign-on URL endpoint provided by the PDC team, similar to
   "https://example.org/realms/pdc/broker/okta-saml-foundation/endpoint"
   into Okta's "Single sign-on URL"
10. Paste the SP Entity ID URL provided by the PDC team, similar to
    "https://example.org/realms/pdc" into Okta's "Audience URI (SP Entity ID)"
    field.
11. Set the "Name ID format" to "EmailAddress."
12. Set the "Application username" to "Email."
13. Add Attribute Statements:
...
16. Click "Next."
17. Click "Finish."
18. Send Okta's SAML "Metadata URL" to the PDC team.

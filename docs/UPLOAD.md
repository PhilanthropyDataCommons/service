...
- In order to get the data you need, make a `/proposals` or
  `/proposalVersions` GET request and copy the response. You can use
  that data to create a stripped down POST request as below.

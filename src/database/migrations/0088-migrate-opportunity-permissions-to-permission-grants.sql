...
-- Drop old opportunity permission tables and types
DROP TABLE IF EXISTS user_opportunity_permissions;
DROP TABLE IF EXISTS user_group_opportunity_permissions;

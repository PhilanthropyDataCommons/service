...
const removeOrganizationDataProviderPermission = async (
	keycloakOrganizationId: KeycloakId,
	dataProviderShortCode: ShortCode,
	permission: Permission,
): Promise<void> => {
	const result = await db.sql('organizationDataProviderPermissions.deleteOne', {
...
export { removeOrganizationDataProviderPermission };

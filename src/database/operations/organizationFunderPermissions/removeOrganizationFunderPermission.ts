...
const removeOrganizationFunderPermission = async (
	keycloakOrganizationId: KeycloakId,
	funderShortCode: ShortCode,
	permission: Permission,
): Promise<void> => {
	const result = await db.sql('organizationFunderPermissions.deleteOne', {
...
export { removeOrganizationFunderPermission };

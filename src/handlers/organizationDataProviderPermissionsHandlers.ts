import {
	db,
	assertOrganizationDataProviderPermissionExists,
	createOrUpdateOrganizationDataProviderPermission,
	removeOrganizationDataProviderPermission,
} from '../database';
import {
	isAuthContext,
	isId,
...
const deleteOrganizationDataProviderPermission = (
	req: Request,
	res: Response,
	next: NextFunction,
): void => {
	...
	(async () => {
		await assertOrganizationDataProviderPermissionExists(
			keycloakOrganizationId,
			dataProviderShortCode,
			permission,
		);
		await removeOrganizationDataProviderPermission(
			keycloakOrganizationId,
			dataProviderShortCode,
			permission,
		);
...
const putOrganizationDataProviderPermission = (
	req: Request,
	res: Response,
	next: NextFunction,
): void => {
	...
	(async () => {
		const organizationFunderPermission =
			await createOrUpdateOrganizationDataProviderPermission(db, null, {
				keycloakOrganizationId,
				dataProviderShortCode,
				permission,
				createdBy,
...
const organizationDataProviderPermissionsHandlers = {
	deleteOrganizationDataProviderPermission,
	putOrganizationDataProviderPermission,
};

export { organizationDataProviderPermissionsHandlers };

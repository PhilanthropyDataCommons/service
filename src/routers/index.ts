...
import { funderCollaborativeMembersRouter } from './funderCollaborativeMembersRouter';
...
rootRouter.use('/funderCollaborativeMembers', funderCollaborativeMembersRouter);

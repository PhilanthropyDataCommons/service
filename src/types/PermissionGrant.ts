...
import { jsonSchemaTypeForEntityKeyType } from './PermissionGrantEntityKeyType';
import {
...
const getSchemaFragmentForContextEntityType = (
	...
	return {
		properties: {
			...
			[keyName]: { type: jsonSchemaTypeForEntityKeyType[keyType] },
		},
...
const getSchemaForWritablePermissionGrantVariant = (
	...
	return {
		...
		properties: {
			scope: {
				type: 'array',
				items: permissionGrantEntityTypeSchema,
				minItems: 1,
			},
			verbs: {
				type: 'array',

...
export type PresignedPostRequestWrite = Omit<PresignedPostRequest, 'presignedPost'>;
...
export const isPresignedPostRequestWrite = ajv.compile(presignedPostRequestSchema);
